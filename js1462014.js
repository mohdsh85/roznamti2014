...
var filterList=filterListBoxTwo='';
...
function  showsearchBox(nextCat,secureCat,title,searchCatList,secureSearchCatList,table_for_sub_cat_box_2,table_for_sub_cat_box_2_secure,no_keyword_search,lable_one,lable_two,lable_three,lable_four,lable_five,lable_six,innerPage,lable_two_selected,lable_three_selected,lable_four_selected,lable_five_selected,lable_six_selected)
{
	...
	if(nextCat!=currentSelectedcat)
	{
		...
		c+='<div class="thred"> <input type="text" value="'+lable_one+'" style="width:100%" class="inputStyle2" '+disabledkeyword+' onfocus="emptyFiledKeepValue(\''+lable_one+'\',\'keywordValue\')" onblur="checkFiledReturnValue(\'keywordValue\')"  id="keywordValue" /> </div>';
		...
		c+='<div class="thred"> <input  type="text" style="width:100%" class="inputStyle2"  id="inputFieldJS" name="inputFieldJS" value="'+lable_four_selected+'" onblur="" /> </div>';
		
		c+='<div class="thred"> <input name="" type="text"  class="inputStyle2" id="fromTimeJs" value="'+lable_five_selected+'"   />';
